    ...
    $.widget("ceb.cebdropdown", {
        ...
        _getPluginOptions: function () {
            ...
            return $.extend({}, $this.options, {
                ...
                templates:
                {
                    button: '<button type="button" aria-labeledby="' + ($this.element.attr("aria-labeledby") || ' ') + '" class="multiselect dropdown-toggle" data-toggle="dropdown"></button>',
                    ul: '<ul class="multiselect-container dropdown-menu" style="width:' + $this.options.buttonWidth + ';overflow: hidden;"></ul>',
                ...
                onDropdownHidden: function(event) { this.$button.focus(); },
                onDropdownShown: function(event) { $(this.$filter).find('input').focus(); },
